...
# Customize the plot
plt.title(f'Efficiency - Strong Scaling, MPI Processes = {processes}')
...
plt.savefig(f'/Users/davide/Desktop/Parallel-KMeans/Plots/mpi_omp/efficiency_fixed_proc_mpi_omp_{processes}.png', dpi=150)
