...
filtered_plot_data = filtered_data[(filtered_data['Processes'] == processes) & (filtered_data['Threads'].isin(threads_set))]
...
# Customize the plot
plt.title(f'Runtime, MPI Processes = {processes}')
...
plt.savefig(f'/Users/davide/Desktop/Parallel-KMeans/Plots/mpi_omp/exectime_fixed_proc_mpi_omp_{processes}.png', dpi=150)
